...
export const articles:Article[]=[
  {id:'colour-and-tile',category:'DESIGN NOTES',title:'How to pair wall colour with the tile you love',excerpt:'A simple way to build a room palette from the floor up—without guessing from a tiny sample.',image:'/tiles/marble_01.jpg',imageAlt:'Photographed warm stone tile material',readTime:'4 MIN READ',sections:[
  ...
  {id:'room-by-room',category:'MATERIAL GUIDE',title:'Choosing surfaces room by room',excerpt:'The same home can hold more than one tile story. Here is how to keep it feeling connected.',image:'/tiles/wood_floor.jpg',imageAlt:'Photographed wood floor material',readTime:'5 MIN READ',sections:[
  ...
  {id:'small-spaces',category:'STUDIO JOURNAL',title:'Small spaces, confident pattern',excerpt:'Scale, light and one considered accent can make a compact space feel distinctly yours.',image:'/tiles/old_mosaic_floor.jpg',imageAlt:'Photographed mosaic tile material',readTime:'3 MIN READ',sections:[
